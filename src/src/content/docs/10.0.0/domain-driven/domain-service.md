...
slug: 10.0.0/domain-driven/domain-service
---
...
* 学习[工作单元](/10.0.0/domain-driven/unit-of-work/)理解事务管理
* 阅读[聚合根](/10.0.0/domain-driven/aggregate-root/)理解聚合设计
* 查看[仓储](/10.0.0/domain-driven/repository/)了解数据访问
