...
slug: 10.0.0/domain-driven/unit-of-work
---
...
* 学习[仓储](/10.0.0/domain-driven/repository/)了解数据访问
* 阅读[领域事件](/10.0.0/domain-driven/domain-event/)理解事件处理
* 查看[聚合根](/10.0.0/domain-driven/aggregate-root/)理解聚合边界
