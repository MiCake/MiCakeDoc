...
description: Learn about MiCake's dependency injection enhancements, including
  auto-registration, service marker interfaces, and lifecycle management
slug: en/10.0.0/dependency-injection
---
