...
description: A thread-safe LRU cache implementation with capacity limits and an
  optional segment strategy
slug: en/10.0.0/utilities/cache/bounded-lru-cache
---
