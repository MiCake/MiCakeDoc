...
description: A temporary data storage pool with capacity limits, suitable for
  scenarios that need to temporarily store and retrieve data
slug: en/10.0.0/utilities/storage
---
