...
description: Learn about MiCake's soft delete feature, implementing logical
  deletion instead of physical deletion for easy data recovery and auditing
slug: en/10.0.0/soft-delete
---
